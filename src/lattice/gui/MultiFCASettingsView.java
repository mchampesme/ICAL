...
/**
 * @author rouanehm Created on 28-Apr-2004 To change the template for this
 *         generated type comment go to Window&gt;Preferences&gt;Java&gt;Code
 *         Generation&gt;Code and Comments
 */

public class MultiFCASettingsView extends JDialog implements ActionListener,
    ...
    private JRadioButton latticeRadioButton = new JRadioButton(
                                                               "Complete lattice");

    private JRadioButton gshRadioButton = new JRadioButton(
    ...
    public static boolean getSettings(RelationalContextFamily relCtx,
    ...
    public void valueChanged(ListSelectionEvent arg0) {
        if (arg0.getSource() == contextsList) {
            ...
            if (contextsList.getSelectedIndex() != -1) {
                for (int i = 0; i < contextsList.getSelectedValues().length; i++) {
                    selectedContexts.add(contextsList.getSelectedValues()[i]
                            .toString());
                }
        ...
        if (arg0.getSource() == relAttributesList) {
            ...
            if (contextsList.getSelectedIndex() != -1) {
                for (int i = 0; i < relAttributesList.getSelectedValues().length; i++) {
                    selectedRelAttributes.add(relAttributesList
        ...
        if (arg0.getSource() == initialContextsList) {
            ...
            selectedInitialContext = initialContextsList.getSelectedValue()
                    .toString();
        }
    }
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        if (arg0.getSource() == gshRadioButton) {
            ...
            JOptionPane
                    .showMessageDialog(this,
                                       "Option not available yet, the complete lattice will be used");
        ...
        if (arg0.getSource() == fireButton) {
            if (selectedInitialContext != null) {
                ...
                JOptionPane
                        .showMessageDialog(this,
                                           "You must choose an initial context");
            }
        }// if
    ...
    public static void displayRCFSettings() {
        if (getExitStatus() == -1) {
            ...
            System.out
                    .println("Selected relational (object-valued) attributes:");
    ...
    public static boolean checkUMLFormat(RelationalContextFamily rcf) {
        if (rcf.getForName("Classes") == null)
            return false;
        if (rcf.getForName("Relations") == null)
            return false;
        if (rcf.getForName("outgoing") == null)
            return false;
        if (rcf.getForName("incoming") == null)
            return false;
        if (rcf.getForName("source") == null)
            return false;
        if (rcf.getForName("target") == null)
            return false;
        return true;
    }
