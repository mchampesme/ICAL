...
public class NestedLatticeNode extends ConceptNodeImp {
  ...
  public NestedLatticeNode(Integer id, ConceptImp concept) {
    super(id, concept);
  }

  public NestedLatticeNode(ConceptImp concept) {
    super(concept);
  }
  ...
  public void setNestedLattice(CompleteConceptLattice cl) {
    nestedLattice = cl;
  }
