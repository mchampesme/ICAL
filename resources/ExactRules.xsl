...
<xsl:template match="/">
  <HTML>
	<HEAD>
		...
		<br><h2>2. Exact Rule Basis </h2></br>
...
<xsl:template match="nombre_regles">
   <p> Exact rule basis generates a minimal set of valid implication rules. It has <b><xsl:value-of select="." /></b> rules.</p>
</xsl:template>
