...
class XYZLatModel {
  ...
  XYZLatModel (LatticeGraphViewer lgv, Vector niveau, boolean labl, boolean bx, boolean bnds, Color bgcolor, Color bndcolor, Color bxcolor) throws Exception{
    this();
    this.lgv = lgv;
    this.label=labl;
    this.box=bx;
...
private double calcTension(Vector niveau) {
  ...
  XYZLatModel (InputStream is, boolean labl, boolean bx, boolean bnds, Color bgcolor, Color bndcolor, Color bxcolor) throws Exception
  {
    ...
    this.xb=bxcolor.getBlue();
    atomTable = new Hashtable();
    defaultAtom = new ScaleableAtomImpl(255, 100, 200, 1.0);
    try
    {
      scan:
      while (true)
