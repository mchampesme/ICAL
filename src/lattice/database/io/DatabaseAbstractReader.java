...
/**
 * An abstract class to define a database reader
 * @author Manuel Aupetit
 */
public abstract class DatabaseAbstractReader extends AbstractJob {

	Object data = null;
	protected String defaultNameForData = "Default Name";
	
	public String getDescription(){
		return "Database Reading Job";
	}
